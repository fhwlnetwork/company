...
<div class="a">
<div class="b"><img src="images/rec_30.jpg" /></div>
<div class="c"></div>
</div>
...
mysql_select_db('ts_zzyd',$conn)or die('找不到数据库'.mysql_error());//选择数据库
    $sql="select * from ts_recruit order by id desc";
...
?>
    ...
    <tr height="20">
        <td width="200" height="191"> <?php  echo "<a href=\"../public/news_show.php?id=$row[id]\">"; echo $row['title']; echo "</a></td>";?>
        <td width="300" height="191"><?php echo $row['content']?></td>
        <td width="100" height="20"><?php echo $row['admin']?></td>
        <td width="200" height="20"><?php echo $row['time']?></td>
    ...
    <tr>
        <td colspan="3">
            ...
            <a href="../web/adv.php?page=1">首页</a>
            <a href="../web/adv.php?page=<?php echo $pagePrev ?> ">第一页</a>
            <a href="../web/adv.php?page=<?php echo $pageNext?>">下一页</a>
            <a href="../web/adv.php?page=<?php echo $pageCount?>">最后一页</a>
