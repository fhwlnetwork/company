...
?>
    ...
    <tr height="40">
        <td width="50" height="191"> <?php  echo "<a href=\"../public/news_show.php?id=$row[id]\">"; echo $row['title']; echo "</a></td>";?>
        <td width="450" height="191"><?php echo $row['admin']?></td>
        <td width="100" height="20"><?php echo $row['content']?></td>
        <td width="250" height="20"><?php echo $row['time']?></td>
        <td width="40"><?php  echo "<a href=\"del_jobdo.php?id=$row[id]\">";?>删除</td>
